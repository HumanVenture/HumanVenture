		...
		<div class="container">
			<div class="navbar-header">
				...
				<div class="row row-flex align">
					<div class="col-xs-8 col-sm-8 col-md-8 col-lg-offset-1 col-lg-7">
						<a class="navbar-brand" href="<?php bloginfo('url'); ?>">
							<img class="img-responsive" src="<?php bloginfo('template_url'); ?>/logo_white.svg">
						</a>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-offset-2 col-lg-2">
				...
				<div class="row">
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-offset-1 col-lg-3">
